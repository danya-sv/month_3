...
BAD_WORDS = (
    "дурак", "тупой", "идиот", "тупица", "козел", "урод", "свинья", "дебил", "тварь", "глупый",
    "придурок", "тупорылый", "сволочь", "гнида", "мразь", "засранец", "петух", "бестолковый", 
    "неумеха", "недоумок", "лох", "чмо", "недалёкий", "недоразвитый", "балбес", "недостаточный",
    "бестолковый", "безмозглый", "обалдуй", "кабан", "мерзавец", "слабоумный", "лжесвидетель",
    "тупорылый", "подлец", "дрянь", "неспособный", "бездарь", "несообразительный", "жалкий", "глупыш",
    "недружелюбный", "невежа", "неумный", "неотёсанный", "бестолковый", "неудачник"
)
